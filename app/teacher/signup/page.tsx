  ...
  return (
    <main className={styles.shell}>
      <section className={styles.card}>
        ...
        <span className="mono-label">{t("teacher.signup")}</span>
        <h1 className={styles.title}>{t("teacher.signup")}</h1>
        ...
        <form
          ...
          onSubmit={async (e) => {
            ...
            const login = await fetch("/api/teacher/login", {
              method: "POST",
              headers: { "content-type": "application/json" },
        ...
        >
          ...
          <label className={styles.field}>
            <span className={styles.label}>{t("teacher.name")}</span>
            <input
              name="name"
              type="text"
              autoComplete="name"
